...
selected_players = st.multiselect(
    ...
    default=["Mike Clancy","Marley Anderson","Megan Silavongsa","Kevin Dinh", "TonyTam Dinh", "Mark Le","Jet Li Thach","Kevin Vu","England Nguyen","Reagan Phonsa","Kayu Southichark","Travis Visounnaraj","Pete Visounnaraj","Olivia Cunningham"]
) #
